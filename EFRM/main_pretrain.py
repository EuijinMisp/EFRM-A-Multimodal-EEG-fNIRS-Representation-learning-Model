# code/main_pretrain.py
"""
Entrypoint for pretraining the EFRM model.
Parses arguments and launches single- or multi-GPU pretraining via solver.
"""
...
def main():
    ...
    ################################### Common Parameters ###################################
    parser.add_argument('--mode', default='pretrain', help='pretrain')
    parser.add_argument('--run_name', default='EFMF', help='EFMF')
    ...
    parser.add_argument('--port', type=int, default=12355, metavar='N', help='input batch size for training (default: 64)')
    ...
    parser.add_argument('--pre_model_save_path', default='../run/pretrain', help='folder to output validation images and model checkpoints')
    parser.add_argument('--pre_lr', type=float, default=1e-4, metavar='LR', help='learning rate (default: 0.0001)')
    parser.add_argument('--pre_niter', type=int, default=300, metavar='N', help='number of epochs to train (default: 500)')
    parser.add_argument('--mask_ratio', type=float, default=0.5, help='mask_ratio')
    parser.add_argument('--load_model_path', default='../run/pretrain', help='load_model_path')
...
def main_worker(rank, args):
    """Per-process worker for distributed pretraining or single-GPU training."""
    ...
    if self.multigpu_use if hasattr(self, 'multigpu_use') else False:
        pass
