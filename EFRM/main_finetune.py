# code/main_finetune.py
"""
Entrypoint for fine-tuning experiments for EFRM.

This script parses arguments and launches single- or multi-GPU training using the solver.
"""
...
def main():
    ...
    ################################### Common Parameters ###################################
    parser.add_argument('--mode', default='finetune', help='finetune')
    ...
    parser.add_argument('--batch_size', type=int, default=16, metavar='N', help='8')
    ...
    parser.add_argument('--fine_model_save_path', default='../run/finetune', help='fine_model_save_path')
    parser.add_argument('--fine_lr', type=float, default=1e-4, metavar='LR', help='learning rate (default: 0.0001)')
    parser.add_argument('--fine_niter', type=int, default=50, metavar='N', help='number of epochs to train (default: 50)')
